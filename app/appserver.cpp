...
int main(int argc, char* argv[])
{
   ...
   //The order of the following step MUST NOT be changed unless it is exciplitly explained.
   //
...
//step 2.
   ...
   cout << "Flow control window size: " << intval << endl;
   ...
   //The following two methods can be put after step 3 and before step 4.
   intval = 256000;
...
//step 5.
   ...
   try
   {
      while (server->getCurrSndBufSize())
         usleep(10);
   }
   catch(CUDTException e)
   {
